...
โหมดเซิร์ฟเวอร์เป็นแบบ opt-in เท่านั้น เมื่อเปิดใช้งาน ให้ตั้งค่า `UNIFIA_SERVER_PASSWORD` เพื่อบังคับใช้ HTTP Basic Auth หากไม่ตั้ง เซิร์ฟเวอร์จะทำงานโดยไม่มีการรับรองตัวตน (พร้อมคำเตือน) เป็นความรับผิดชอบของผู้ใช้ปลายทางที่จะรักษาความปลอดภัยเซิร์ฟเวอร์ — ฟังก์ชันใดก็ตามที่มันให้ไว้ไม่ใช่ช่องโหว่
