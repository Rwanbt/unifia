...
সার্ভার মোড শুধুমাত্র অপ্ট-ইন। সক্রিয় করার সময়, HTTP Basic Auth প্রয়োজন করতে `UNIFIA_SERVER_PASSWORD` সেট করুন। এটি ছাড়া সার্ভার অননুমোদিতভাবে চলে (একটি সতর্কতা সহ)। সার্ভার সুরক্ষিত করা শেষ ব্যবহারকারীর দায়িত্ব — এটি যে কোনও কার্যকারিতা প্রদান করে তা একটি দুর্বলতা নয়।
