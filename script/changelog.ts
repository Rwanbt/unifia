...
Generates UPCOMING_CHANGELOG.md by running the unifia changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for unifia run (default: low)
      --quiet            Suppress unifia command output unless it fails
