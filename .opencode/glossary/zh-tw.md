...
- `Unifia` (preserve casing in prose; keep `unifia` only when it is part of commands, package names, paths, or code)
- `Unifia Zen`
- `Unifia CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `unifia` in prose when referring to the product name; use `Unifia`
