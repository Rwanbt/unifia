...
Use for core server issues in `packages/unifia/`, excluding `packages/unifia/src/cli/cmd/tui/`.
...
TUI (`packages/unifia/src/cli/cmd/tui/...`):
...
Core (`packages/unifia/...`, excluding TUI subtree):
