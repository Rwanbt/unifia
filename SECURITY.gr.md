...
Για να αναφέρετε ένα θέμα ασφαλείας, χρησιμοποιήστε την καρτέλα GitHub Security Advisory ["Report a Vulnerability"](https://github.com/Rwanbt/opencode/security/advisories/new).
