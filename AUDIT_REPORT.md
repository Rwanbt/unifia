...
- **Fichier** : [packages/unifia/src/util/token.ts:2-5](packages/unifia/src/util/token.ts#L2-L5), dupliqué inline à [packages/unifia/src/session/llm.ts:171](packages/unifia/src/session/llm.ts#L171)
- **Observé** : `CHARS_PER_TOKEN = 4`, retourne `Math.round(length/4)`. Utilisé dans [compaction.ts:135](packages/unifia/src/session/compaction.ts#L135) pour décider quelle `tool part` compacter.
- **Impact** :
...
- **Fichier** : [packages/unifia/src/session/llm.ts:62](packages/unifia/src/session/llm.ts#L62)
- **Observé** : `reasoningBudget = Math.min(Math.max(128, maxTokens*0.1), 1024)`. Utilisé en [llm.ts:381](packages/unifia/src/session/llm.ts#L381) via `providerOptions[local-llm].reasoning_budget`.
...
- **Fichier** : [packages/unifia/src/session/llm.ts:107-119](packages/unifia/src/session/llm.ts#L107-L119) (wrapper Effect), `streamText` ligne [331](packages/unifia/src/session/llm.ts#L331).
...
- **Observé** : le cleanup Rust/TS réagit à `SIGTERM`/`SIGINT` + `atexit` ([local-llm-server/index.ts:262-281](packages/unifia/src/local-llm-server/index.ts#L262-L281)) mais :
...
- **Fichier** : [packages/unifia/src/session/llm.ts:140-145](packages/unifia/src/session/llm.ts#L140-L145)
...
- **Fichier** : [packages/unifia/src/local-llm-server/index.ts:508-554](packages/unifia/src/local-llm-server/index.ts#L508-L554)
...
- **Fichier** : [packages/unifia/src/local-llm-server/index.ts:480-537](packages/unifia/src/local-llm-server/index.ts#L480-L537)
...
- **Fichier** : [packages/unifia/src/local-llm-server/index.ts:135](packages/unifia/src/local-llm-server/index.ts#L135)
...
- **Fichier** : [packages/unifia/src/session/llm.ts:171](packages/unifia/src/session/llm.ts#L171)
...
- **Fichier** : [packages/unifia/src/local-llm-server/index.ts:55-71](packages/unifia/src/local-llm-server/index.ts#L55-L71)
...
|---|---|---|
| « Compaction coupe au milieu d'un tool_use / thinking » | **Faux** — la boucle `compaction.ts:124-143` opère **part-wise**, elle marque entièrement les `tool parts` complètes comme compactées. Pas de coupe intra-part. | [compaction.ts:124-143](packages/unifia/src/session/compaction.ts#L124-L143) |
...
| « Double-spawn concurrent llama-server » | **Atténué** — `_startPromise` + re-check post-lock sont en place. Risque résiduel = A.12 (PID stale). | [local-llm-server/index.ts:567-626](packages/unifia/src/local-llm-server/index.ts#L567-L626) |
