...
يتوفر Unifia Workbench ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/Rwanbt/opencode/releases) او من [unifia.ai/download](https://opencode.ai/download).
