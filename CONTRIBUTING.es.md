...
Para detalles completos sobre configuración del entorno de desarrollo, comandos de build y configuración del debugger, consulta el original en inglés [CONTRIBUTING.md](CONTRIBUTING.md).
