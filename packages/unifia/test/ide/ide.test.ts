...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders UNIFIA_CALLER", () => {
    process.env["UNIFIA_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode UNIFIA_CALLER", () => {
    process.env["UNIFIA_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown UNIFIA_CALLER", () => {
    process.env["UNIFIA_CALLER"] = "unknown"
