...
Practical reference for new and migrated Effect code in `packages/unifia`.
...
Tool tests should use the existing Effect helpers in `packages/unifia/test/lib/effect.ts`:
