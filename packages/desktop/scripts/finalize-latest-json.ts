...
const releaseId = process.env.UNIFIA_RELEASE
if (!releaseId) throw new Error("UNIFIA_RELEASE is required")

const version = process.env.UNIFIA_VERSION
if (!releaseId) throw new Error("UNIFIA_VERSION is required")
...
const targets = [
  { key: "linux-x86_64-deb", asset: "unifia-desktop-linux-amd64.deb" },
  { key: "linux-x86_64-rpm", asset: "unifia-desktop-linux-x86_64.rpm" },
  { key: "linux-aarch64-deb", asset: "unifia-desktop-linux-arm64.deb" },
  { key: "linux-aarch64-rpm", asset: "unifia-desktop-linux-aarch64.rpm" },
  { key: "windows-aarch64-nsis", asset: "unifia-desktop-windows-arm64.exe" },
  { key: "windows-x86_64-nsis", asset: "unifia-desktop-windows-x64.exe" },
  { key: "darwin-x86_64-app", asset: "unifia-desktop-darwin-x64.app.tar.gz" },
  {
    key: "darwin-aarch64-app",
    asset: "unifia-desktop-darwin-aarch64.app.tar.gz",
  },
]
