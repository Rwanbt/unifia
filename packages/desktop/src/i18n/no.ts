export const dict = {
  ...
  "desktop.menu.help.documentation": "Unifia Dokumentasjon",
  ...
  "desktop.cli.error.sidecarMissing": "Unifia CLI-binærfil mangler. Prøv å installere skrivebordsappen på nytt.",
