...
export const commands = {
	...
	openDesignBrowser: (url: string) => __TAURI_INVOKE<string>("open_design_browser", { url }),
	navigateDesignBrowser: (label: string, action: string) => __TAURI_INVOKE<null>("navigate_design_browser", { label, action }),
	closeDesignBrowser: (label: string) => __TAURI_INVOKE<null>("close_design_browser", { label }),
	...
	ttsSpeak: (text: string, voice: string | null, language?: string | null) => __TAURI_INVOKE<string>("tts_speak", { text, voice, language }),
