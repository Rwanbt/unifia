...
export type CapabilityManifest = { descriptor: CapabilityDescriptor; digest: string; sourceRepo: string; sourceCommit: string; license: LicenseVerdict; attribution?: string; remoteCode: boolean }
