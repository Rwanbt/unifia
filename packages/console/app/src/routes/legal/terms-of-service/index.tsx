...
export default function TermsOfService() {
  ...
  return (
    <main data-page="legal">
      <Title>Unifia | Terms of Service</Title>
      <LocaleLinks path="/legal/terms-of-service" />
      <Meta name="description" content="Unifia terms of service" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="terms-of-service">
              ...
              <p>
                Welcome to Unifia. Please read on to learn the rules and restrictions that govern your use of
                Unifia&apos;s website, inference product and hosted software offering (the "Services"). If you have
              ...
              <p>
                ...
                <strong>ANOMALY INNOVATIONS, INC.</strong> ("Unifia," "we" and "us"). Your use of the Services in any
              ...
              <h2 id="what-is-unifia">What is Unifia?</h2>
              <p>
                Unifia is an AI-powered coding agent that helps you write, understand, and modify code using large
                language models. Certain of these large language models are provided by third parties ("Third Party
                Models") and certain of these models are provided directly by us if you use the Unifia Zen paid
                offering ("Zen"). Regardless of whether you use Third Party Models or Zen, Unifia enables you to
              ...
              <p>
                ...
                our site located at unifia.ai, send you an email, and/or notify you by some other means.
              </p>
              ...
              <p>
                Unifia takes the privacy of its users very seriously. For the current Unifia Privacy Policy, please
                click here{" "}
              ...
              <h2 id="what-are-the-basics">What are the basics of using Unifia?</h2>
              <p>
              ...
              <ol style="list-style-type: lower-alpha;">
                ...
                <li>
                  ...
                  privacy laws or any other purpose not reasonably intended by Unifia;
                </li>
                <li>
              ...
              <p>
                If you use Unifia with Third Party Models, then your Content will be subject to the data retention
              ...
              <p>
                ...
                Unifia. Your ability to access Third Party Models is contingent on you having API keys or otherwise
                having the right to access such Third Party Models.
              </p>

              <p>
                Unifia has no control over, and assumes no responsibility for, the content, accuracy, privacy
              ...
              <h2 id="will-unifia-ever-change-the-services">Will Unifia ever change the Services?</h2>
              <p>
              ...
              <p>
                Unifia is also free to terminate (or suspend access to) your use of the Services for any reason in our
                discretion, including your breach of these Terms. Unifia has the sole right to decide whether you are
              ...
              <p>
                Unifia and its licensors, suppliers, partners, parent, subsidiaries or affiliated entities, and each
                of their respective officers, directors, members, employees, consultants, contract employees,
                representatives and agents, and each of their respective successors and assigns (Unifia and all such
                parties together, the "Unifia Parties") make no representations or warranties concerning the Services,
                including without limitation regarding any Content contained in or accessed through the Services, and
                the Unifia Parties will not be responsible or liable for the accuracy, copyright compliance, legality,
                ...
                participation in, the Services. The Unifia Parties make no representations or warranties regarding
              ...
              <h3>Indemnity</h3>
              <p>
                You agree to indemnify and hold the Unifia Parties harmless from and against any and all claims,
              ...
              <p>
                ...
                Services account, in any way (by operation of law or otherwise) without Unifia's prior written
              ...
              <p>
                ...
                disputes and claims with Unifia and limits the manner in which you can seek relief from Unifia. Both
                you and Unifia acknowledge and agree that for the purposes of any dispute arising out of or relating
                to the subject matter of these Terms, Unifia's officers, directors, employees and independent
              ...
              <p>
                The Rules will govern payment of all arbitration fees. Unifia will pay all arbitration fees for claims
                less than seventy-five thousand ($75,000) dollars. Unifia will not seek its attorneys' fees and costs
                in arbitration unless the arbitrator determines that your claim is frivolous.
              </p>

              <h4>Small Claims Court; Infringement</h4>
              <p>
                Either you or Unifia may assert claims, if they qualify, in small claims court in New Castle County,
              ...
              <p>
                ...
                OF A JUDGE OR JURY. You and Unifia are instead choosing to have claims and disputes resolved by
                ...
                you and Unifia over whether to vacate or enforce an arbitration award, YOU AND OPENCODE WAIVE ALL
              ...
              <p>
                ...
                Unifia is entitled to arbitration; instead all claims and disputes will be resolved in a court as set
                forth in (g) below.
              </p>
              ...
              <p>
                ...
                agreement permits either you or Unifia to litigate any dispute arising out of or relating to the
                subject matter of these Terms in court, then the foregoing arbitration agreement will not apply to
                either party, and both you and Unifia agree that any judicial proceeding (other than small claims
              ...
              <p>
                ...
                the Unifia may, in its sole discretion, do any of the foregoing on your behalf or for itself as it
                ...
                Terms shall otherwise remain in full force and effect and enforceable. You and Unifia agree that these
                Terms are the complete and exclusive statement of the mutual understanding between you and Unifia, and
                ...
                are not an employee, agent, partner, or joint venture of Unifia, and you do not have any authority of
                any kind to bind Unifia in any respect whatsoever.
              </p>

              <p>
                Except as expressly set forth in the section above regarding the arbitration agreement, you and Unifia
