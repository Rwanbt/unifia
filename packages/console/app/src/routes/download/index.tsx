        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              ...
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g unifia-ai")}>
                <code>
                  bun add -g <strong>unifia-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S unifia")}>
                <code>
                  paru -S <strong>unifia</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask unifia-desktop")}>
                <code>
                  brew install --cask <strong>unifia-desktop</strong>
                </code>
                <CopyStatus />
              </button>
