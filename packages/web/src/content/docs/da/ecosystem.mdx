---
title: Økosystem
description: Projekter og integrationer bygget med Unifia.
---

En samling af samfundsprojekter bygget på Unifia.

:::note
Vil du tilføje dit OpenCode-relaterede projekt til denne liste? Send en PR.
:::

Du kan også tjekke [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) og [unifia.cafe](https://opencode.cafe), et fællesskab, der samler økosystemet og fællesskabet.
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Spor Unifia brug med Wakatime                                                                                   |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Baggrundsagenter, præbyggede LSP/AST/MCP værktøjer, kuraterede agenter, Claude Kodekompatibel                     |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Udvid unifia /commands til et kraftfuldt orkestreringssystem med granulær flowkontrol                           |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-meddelelser for Unifia – ved, hvornår opgaver er fuldført                                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nulfriktions git-arbejdstræer for Unifia                                                                        |
...
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin til redaktør-bevidste prompter, bygget på API            |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI til Unifia over Tailscale/VPN                    |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Skabelon til at bygge Unifia plugins                                 |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-frontend til unifia - en terminalbaseret AI-kodningsagent     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK udbyder til brug af Unifia via @opencode-ai/sdk        |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App og VS Code udvidelse til Unifia                    |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin, der integrerer Unifia i Obsidians brugergrænseflade |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et open source-alternativ til Claude Cowork, drevet af Unifia        |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia udvidelsesmanager med bærbare, isolerede profiler.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, web-, mobil- og fjernklientapp til Unifia                  |
