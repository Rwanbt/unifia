...
Agentferdigheter lar Unifia oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går Unifia opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
Unifia viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `unifia.json`:
