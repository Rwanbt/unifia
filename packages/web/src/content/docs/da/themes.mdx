...
Med Unifia kan du velge fra ett av flere innebygde temaer, bruge et tema som tilpasser seg terminaltemaet ditt, eller definere ditt eget tilpassede tema.

Som standard bruger Unifia vårt eget `unifia`-tema.
...
Unifia kommer med flere innebygde temaer.
...
- Vil at Unifia skal matche terminalens utseende
...
Unifia støtter et fleksibelt JSON-basert temasystem som lar brugere enkelt lage og tilpasse temaer.
