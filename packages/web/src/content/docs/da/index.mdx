---
title: Introduktion
description: Kom godt i gang med Unifia.
---
...
[**Unifia**](/) er en open source AI-kodningsagent. Den er tilgængelig som en terminalbaseret grænseflade, desktop-app eller IDE-udvidelse.
...
For at bruge Unifia i din terminal skal du bruge:
...
Den nemmeste måde at installere Unifia på er gennem installationsscriptet.
...
- **Brug af Homebrew på macOS og Linux**
  ...
  > Vi anbefaler at bruge OpenCode-tap for at få de mest opdaterede udgivelser. Den officielle `brew install unifia`-formel vedligeholdes af Homebrew-teamet og opdateret sjældnere.
...
Support til installation af Unifia på Windows ved hjælp af Bun er i gang.
...
Med Unifia kan du bruge enhver LLM udbyder ved at konfigurere deres API-nøgler.

Hvis du er ny til at bruge LLM-udbydere, anbefaler vi at bruge [Unifia Zen](/docs/zen).
Det er en udvalgt liste over modeller, der er blevet testet og verificeret af Unifia
holde.
...
Derefter initialiseres Unifia for projektet ved at køre følgende kommando.

```bash frame="none"
/init
```

Dette får Unifia til at analysere dit projekt og oprette en `AGENTS.md` fil i
projektets rod.
...
Dette hjælper Unifia med at forstå projektstrukturen og kodningsmønstrene
brugt.
...
Du er nu klar til at bruge Unifia til at arbejde på dit projekt. Spørg det gerne
noget!
...
Du kan bede Unifia om at forklare kodebasen for dig.
...
Du kan bede Unifia om at tilføje nye funktioner til dit projekt. Selvom vi først anbefaler, at du beder den om at lave en plan.

1. **Opret en plan**

   Unifia har en _Plan mode_, der deaktiverer dens evne til at foretage ændringer og
   ...
   Du vil give Unifia nok detaljer til at forstå, hvad du ønsker. Det hjælper
   at tale med det, som om du taler med en juniorudvikler på dit team.

:::tip
Giv Unifia masser af kontekst og eksempler for at hjælpe den med at forstå, hvad du
ønsker.
:::
...
Unifia kan scanne alle billeder, du giver dem og tilføje dem til prompten. Det kan du
...
For mere ligetil ændringer kan du bede Unifia om at bygge den direkte
...
Du vil sikre dig, at du giver en god mængde detaljer, så Unifia gør det rigtige
ændringer.
...
Lad os sige, at du beder Unifia om at foretage nogle ændringer.
...
Unifia vil nu vende tilbage til ændringerne, du har foretaget, og vise din oprindelige besked
igen.
...
Herfra kan du justere prompten og bede Unifia om at prøve igen.
...
De samtaler, du har med Unifia, kan [deles med din
team](/docs/share).
...
Og det er det! Du er nu en professionel i at bruge Unifia.
