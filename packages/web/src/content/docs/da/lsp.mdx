---
title: LSP-servere
description: Unifia integreres med dine LSP-servere.
---

Unifia integreres med Language Server Protocol (LSP) for at hjælpe LLM med at interagere med din kodebase. Den bruger diagnostik til at give feedback til LLM.

---

## Indbyggede

Unifia leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `UNIFIA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når unifia åbner en fil, vil den:
