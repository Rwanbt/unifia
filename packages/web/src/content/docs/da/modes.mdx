...
Tilstande i unifia giver dig mulighed for at tilpasse adfærd, værktøjer og prompter til forskellige brugstilfælde.
...
unifia leveres med to indbyggede tilstande.
...
Konfigurer tilstande i din `unifia.json`-konfigurationsfil:
...
Hvis der ikke er angivet nogen temperatur, bruger unifia modelspecifikke standarder (typisk 0 for de fleste modeller, 0,55 for Qwen-modeller).
