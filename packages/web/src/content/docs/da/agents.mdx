...
Der er to typer agenter i Unifia; primære agenter og subagenter.
...
Unifia leveres med indbyggede primære agenter, **Build** og **Plan**. Vi vil
...
Unifia leveres med to indbyggede underagenter, **Generelt** og **Udforsk**. Vi vil se på dette nedenfor.

---

## Indbyggede

Unifia leveres med to indbyggede primære agenter og to indbyggede subagenter.
...
Konfigurer agent i din `unifia.json`-konfigurationsfil:
...
Hvis ingen temperatur er angivet, bruger Unifia modelspecifikke standardindstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Model-id'et i din OpenCode-konfiguration brugerformatet `provider/model-id`. For eksempel, hvis du bruger [Unifia Zen](/docs/zen), vil du bruge `opencode/gpt-5.1-codex` til GPT 5.1 Codex.
...
:::tip
Kør `unifia models` for at se en liste over de tilgængelige modeller.
:::
