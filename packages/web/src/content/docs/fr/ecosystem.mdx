---
title: Écosystème
description: Projets et intégrations construits avec Unifia.
---

Une collection de projets communautaires construits sur Unifia.

:::note
Vous souhaitez ajouter votre projet lié à Unifia à cette liste ? Soumettez une PR.
:::

Vous pouvez également consulter [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) et [unifia.cafe](https://opencode.cafe), une communauté qui regroupe l'écosystème et la communauté.
...
| Nom                                                                                                | Description                                                                                                                            |
| -------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Exécute automatiquement des sessions Unifia dans des sandbox Daytona isolées avec synchronisation git et prévisualisations en direct |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Suit l'utilisation d'Unifia avec Wakatime                                                                                            |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Agents d'arrière-plan, outils LSP/AST/MCP pré-construits, agents sélectionnés, compatible Claude Code                                  |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifications de bureau et alertes sonores pour les sessions Unifia                                                                  |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nommage automatique de session Zellij alimenté par l'IA basé sur le contexte Unifia                                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permet aux agents Unifia le chargement différé de prompts à la demande avec découverte et injection de compétences                   |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Étend unifia /commands en un système d'orchestration puissant avec contrôle de flux granulaire                                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifications natives de l'OS pour Unifia – sachez quand les tâches sont terminées                                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sans friction pour Unifia                                                                                              |
...
| Nom                                                                                        | Description                                                                 |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord pour contrôler les sessions Unifia, construit sur le SDK      |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim pour des prompts conscients de l'éditeur, construit sur l'API |
| [portal](https://github.com/hosenur/portal)                                                | Interface Web mobile-first pour Unifia via Tailscale/VPN                  |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Modèle pour créer des plugins Unifia                                      |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim pour unifia - un agent de codage IA basé sur terminal     |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Fournisseur Vercel AI SDK pour utiliser Unifia via @opencode-ai/sdk       |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Application Web / Bureau et extension VS Code pour Unifia                 |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian qui intègre Unifia dans l'interface d'Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Une alternative open-source à Claude Cowork, propulsée par Unifia         |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestionnaire d'extensions Unifia avec profils portables et isolés.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Application client Bureau, Web, Mobile et Distante pour Unifia            |
