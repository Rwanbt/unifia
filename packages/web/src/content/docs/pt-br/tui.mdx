---
title: TUI
description: Usando a interface de usuário de terminal unifia.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

O unifia fornece uma interface de terminal interativa ou TUI para trabalhar em seus projetos com um LLM.

Executar unifia inicia o TUI para o diretório atual.
...
Ao usar o TUI do unifia, você pode digitar `/` seguido pelo nome de um comando para executar ações rapidamente. Por exemplo:
...
Adicione um provedor ao unifia. Permite que você selecione entre os provedores disponíveis e adicione suas chaves de API.
...
Saia do unifia. _Aliases_: `/quit`, `/q`
...
Isso é separado do `unifia.json`, que configura o comportamento do servidor/runtime.
...
Use `UNIFIA_TUI_CONFIG` para carregar um caminho de configuração TUI personalizado.
