...
Com o unifia, você pode selecionar um dos vários temas embutidos, usar um tema que se adapta ao tema do seu terminal ou definir seu próprio tema personalizado.

Por padrão, o unifia usa nosso próprio tema `unifia`.
...
O unifia vem com vários temas embutidos.
...
- Querem que o unifia corresponda à aparência do seu terminal
...
O unifia suporta um sistema de temas flexível baseado em JSON que permite aos usuários criar e personalizar temas facilmente.
