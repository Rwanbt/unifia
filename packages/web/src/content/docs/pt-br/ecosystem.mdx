---
title: Ecossistema
description: Projetos e integrações construídos com o Unifia.
---

Uma coleção de projetos da comunidade construídos sobre o Unifia.

:::note
Quer adicionar seu projeto relacionado ao Unifia a esta lista? Envie um PR.
:::

Você também pode conferir [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) e [unifia.cafe](https://opencode.cafe), uma comunidade que agrega o ecossistema e a comunidade.
...
| Nome                                                                                               | Descrição                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Execute automaticamente sessões do Unifia em sandboxes isoladas do Daytona com sincronização git e pré-visualizações ao vivo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Acompanhe o uso do Unifia com Wakatime                                                                                       |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Agentes em segundo plano, ferramentas LSP/AST/MCP pré-construídas, agentes curados, compatível com Claude Code                 |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificações de desktop e alertas sonoros para sessões do Unifia                                                             |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomeação automática de sessões Zellij com suporte de IA com base no contexto do Unifia                                       |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permite que agentes do Unifia carreguem prompts sob demanda com descoberta e injeção de habilidades                          |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estenda unifia /commands em um poderoso sistema de orquestração com controle de fluxo granular                               |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificações nativas do OS para Unifia – saiba quando as tarefas são concluídas                                              |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Worktrees git sem atrito para Unifia                                                                                         |
...
| Nome                                                                                       | Descrição                                                                       |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot do Discord para controlar sessões do Unifia, construído sobre o SDK       |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim para prompts cientes do editor, construído sobre a API            |
| [portal](https://github.com/hosenur/portal)                                                | UI web mobile-first para Unifia sobre Tailscale/VPN                           |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template para construir plugins do Unifia                                     |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim para Unifia - um agente de codificação IA baseado em terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provedor Vercel AI SDK para usar Unifia via @opencode-ai/sdk                  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicativo Web / Desktop e Extensão do VS Code para Unifia                    |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian que incorpora Unifia na UI do Obsidian                        |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Uma alternativa de código aberto ao Claude Cowork, alimentada pelo Unifia     |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gerenciador de extensões Unifia com perfis portáteis e isolados.              |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicativo Desktop, Web, Mobile e Cliente Remoto para Unifia                  |
