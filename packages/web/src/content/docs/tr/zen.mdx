---
title: Zen
description: unifia tarafından sağlanan seçilmiş modeller listesi.
---
...
Unifia Zen, Unifia ekibi tarafından test edilip doğrulanmış modellerin bir listesidir.

:::note
Unifia Zen şu anda beta olarak mevcut.
:::

Zen, Unifia'daki diğer sağlayıcılar gibi çalışır. Unifia Zen'de oturum açıp API anahtarınızı alırsınız. Bu **tamamen isteğe bağlıdır** ve Unifia kullanmak için buna ihtiyacınız yoktur.
...
:::tip
Unifia ile iyi çalışan seçili bir model ve sağlayıcı grubunu test ettik.
:::
...
Unifia Zen, bu modellere erişmenizi sağlayan bir AI ağ geçididir.

---

## Nasıl çalışır

Unifia Zen, Unifia'daki diğer sağlayıcılar gibi çalışır.

1. **<a href={console}>Unifia Zen</a>**'de oturum açın, faturalandırma bilgilerinizi ekleyin ve API anahtarınızı kopyalayın.
2. TUI'de `/connect` komutunu çalıştırın, Unifia Zen'i seçin ve API anahtarınızı yapıştırın.
...
Unifia yapılandırmanızdaki [model id](/docs/config/#models) `opencode/<model-id>` biçimini kullanır. Örneğin, GPT 5.3 Codex için yapılandırmanızda `opencode/gpt-5.3-codex` kullanırsınız.
...
- MiniMax M2.5 Free, sınırlı bir süre için Unifia'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Pro Free, sınırlı bir süre için Unifia'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- MiMo V2 Omni Free, sınırlı bir süre için Unifia'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Qwen3.6 Plus Free, sınırlı bir süre için Unifia'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Nemotron 3 Super Free, sınırlı bir süre için Unifia'da ücretsizdir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
- Big Pickle, sınırlı bir süre için Unifia'da ücretsiz olan gizli bir modeldir. Ekip bu süreyi geri bildirim toplamak ve modeli iyileştirmek için kullanıyor.
...
Unifia Zen'i şunlar için oluşturduk:
...
4. Başka herhangi bir kodlama ajanıyla kullanmanıza izin vererek **kilitlenme olmamasını** sağlamak. Ayrıca Unifia ile her zaman başka herhangi bir sağlayıcıyı da kullanabilmenizi sağlamak.
