---
title: Paylasim
description: unifia konusmalarini genel baglantilarla paylasin.
---

unifia'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda unifia:
...
unifia, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak unifia manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `unifia.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda unifia kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
