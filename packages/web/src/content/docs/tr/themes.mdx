...
unifia ile birden fazla yerleşik tema arasından seçim yapabilir, terminal temanıza uyum sağlayan bir tema kullanabilir veya kendi özel temanızı tanımlayabilirsiniz.

Varsayılan olarak unifia kendi `unifia` temasını kullanır.
...
unifia birden fazla yerleşik temayla gelir.
...
- unifia'un terminal görünümüyle birebir uyumlu olmasını isteyenler
...
unifia, kullanıcıların kolayca tema oluşturup özelleştirebilmesi için esnek bir JSON tabanlı tema sistemi sunar.
