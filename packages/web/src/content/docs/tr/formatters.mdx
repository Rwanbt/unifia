...
description: unifia dile özgü biçimlendiriciler kullanır.
---

unifia, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

unifia, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, unifia bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

unifia bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri unifia yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
