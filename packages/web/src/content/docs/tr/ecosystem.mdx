...
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @unifia/sdk aracılığıyla Unifia kullanmak için Vercel AI SDK sağlayıcısı |
