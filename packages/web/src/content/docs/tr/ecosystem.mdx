---
title: Ekosistem
description: Unifia ile geliştirilen projeler ve entegrasyonlar.
---

Unifia üzerine inşa edilmiş topluluk projeleri koleksiyonu.

:::note
Unifia ile ilgili projenizi bu listeye eklemek ister misiniz? Bir PR gönderin.
:::

Ayrıca ekosistemi ve topluluğu bir araya getiren [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) ve [unifia.cafe](https://opencode.cafe) adreslerine de göz atabilirsiniz.
...
| İsim                                                                                               | Açıklama                                                                                                                      |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Unifia oturumlarını, git senkronizasyonu ve canlı önizlemelerle izole Daytona sanal alanlarında otomatik olarak çalıştırın  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime ile Unifia kullanımını takip edin                                                                                  |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Arka plan aracıları, hazır LSP/AST/MCP araçları, seçilmiş aracılar, Claude Code uyumlu                                        |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Unifia oturumları için masaüstü bildirimleri ve sesli uyarılar                                                              |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Unifia bağlamına dayalı yapay zeka destekli otomatik Zellij oturum isimlendirmesi                                           |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Unifia aracılarının, beceri keşfi ve enjeksiyonu ile istemleri talep üzerine tembel yüklemesine (lazy load) izin verin      |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | unifia /commands komutlarını, ayrıntılı akış kontrolü ile güçlü bir orkestrasyon sistemine genişletin                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Unifia için yerel işletim sistemi bildirimleri – görevlerin ne zaman tamamlandığını bilin                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Unifia için sıfır sürtünmeli git çalışma ağaçları (worktrees)                                                               |
...
| İsim                                                                                       | Açıklama                                                                        |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK üzerine inşa edilmiş, Unifia oturumlarını kontrol eden Discord botu       |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API üzerine inşa edilmiş, editör farkındalıklı istemler için Neovim eklentisi   |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN üzerinden Unifia için mobil öncelikli web arayüzü               |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Unifia eklentileri oluşturmak için şablon                                     |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | unifia için Neovim ön yüzü - terminal tabanlı bir yapay zeka kodlama aracısı  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | @opencode-ai/sdk aracılığıyla Unifia kullanmak için Vercel AI SDK sağlayıcısı |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Unifia için Web / Masaüstü Uygulaması ve VS Code Uzantısı                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Unifia'u Obsidian arayüzüne gömen Obsidian eklentisi                          |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Unifia tarafından desteklenen, Claude Cowork'e açık kaynaklı bir alternatif   |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Taşınabilir, izole profillere sahip Unifia eklenti yöneticisi                 |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Unifia için Masaüstü, Web, Mobil ve Uzak İstemci Uygulaması                   |
