...
Ajan becerileri, unifia'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
Proje yerel yollarinda unifia, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
...
unifia, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`unifia.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`unifia.json` icinde):
