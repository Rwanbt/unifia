...
Con Unifia puoi scegliere tra diversi temi integrati, usare un tema che si adatta al tema del tuo terminale oppure definire un tema personalizzato.

Per impostazione predefinita, Unifia usa il tema `unifia`.
...
Unifia include diversi temi integrati.
...
- Vuole che Unifia corrisponda all'aspetto del terminale
...
Unifia supporta un sistema di temi flessibile basato su JSON che permette di creare e personalizzare temi facilmente.
