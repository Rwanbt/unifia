---
title: Ecosistema
description: Progetti e integrazioni costruiti con Unifia.
---

Una raccolta di progetti della comunità costruiti su Unifia.

:::note
Vuoi aggiungere il tuo progetto legato a Unifia a questa lista? Apri una PR.
:::

Puoi anche dare un'occhiata a [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) e [unifia.cafe](https://opencode.cafe), una comunità che aggrega ecosistema e community.
...
| Nome                                                                                               | Descrizione                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Esegue automaticamente sessioni Unifia in sandbox Daytona isolate con sync git e anteprime live |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Traccia l'uso di Unifia con Wakatime                                                            |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Agenti in background, tool LSP/AST/MCP predefiniti, agenti curati, compatibile con Claude Code    |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notifiche desktop e avvisi sonori per le sessioni Unifia                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Naming automatico delle sessioni Zellij basato sul contesto Unifia                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permette agli agenti Unifia di caricare prompt al bisogno con discovery e injection di skill    |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Estende unifia /commands in un sistema di orchestrazione con controllo di flusso granulare      |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifiche native del sistema per Unifia: sai quando i task finiscono                            |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git worktree senza attriti per Unifia                                                           |
...
| Nome                                                                                       | Descrizione                                                          |
| ------------------------------------------------------------------------------------------ | -------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot Discord per controllare sessioni Unifia, costruito sull'SDK    |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Plugin Neovim per prompt consapevoli dell'editor, costruito sull'API |
| [portal](https://github.com/hosenur/portal)                                                | Web UI mobile-first per Unifia su Tailscale/VPN                    |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template per costruire plugin Unifia                               |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Frontend Neovim per unifia: un agente di coding AI per terminale   |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Provider Vercel AI SDK per usare Unifia tramite @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | App Web/Desktop ed estensione VS Code per Unifia                   |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Plugin Obsidian che integra Unifia nella UI di Obsidian            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa open source a Claude Cowork, alimentata da Unifia      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Gestore di estensioni Unifia con profili portabili e isolati       |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | App client Desktop, Web, Mobile e remota per Unifia                |
