...
You can add custom commands through the Unifia config or by creating markdown files in the `commands/` directory.

---

### JSON

Use the `command` option in your Unifia [config](/docs/config):
...
unifia includes several built-in commands like `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
