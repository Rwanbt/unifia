---
title: 生态系统
description: 基于 Unifia 构建的项目与集成。
---

基于 Unifia 构建的社区项目合集。

:::note
想将您的 Unifia 相关项目添加到此列表中？欢迎提交 PR。
:::

您还可以查看 [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) 和 [unifia.cafe](https://opencode.cafe)，这是一个聚合生态系统与社区资源的社区。
...
| 名称                                                                                               | 描述                                                                   |
| -------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | 在隔离的 Daytona 沙箱中自动运行 Unifia 会话，支持 git 同步和实时预览 |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | 使用 Wakatime 追踪 Unifia 的使用情况                                 |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | 后台代理、预构建的 LSP/AST/MCP 工具、精选代理，兼容 Claude Code        |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Unifia 会话的桌面通知和声音提醒                                      |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | 针对权限请求、任务完成和错误事件的桌面通知与声音提醒                   |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | 基于 Unifia 上下文的 AI 驱动自动 Zellij 会话命名                     |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | 允许 Unifia 代理通过技能发现和注入按需延迟加载提示词                 |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 将 Unifia /commands 扩展为具有精细流程控制的强大编排系统             |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Unifia 的原生操作系统通知——随时了解任务完成情况                      |
...
| 名称                                                                                       | 描述                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | 用于控制 Unifia 会话的 Discord 机器人，基于 SDK 构建        |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim 插件，提供编辑器感知的提示词，基于 API 构建            |
| [portal](https://github.com/hosenur/portal)                                                | 通过 Tailscale/VPN 使用的移动优先 Unifia Web UI             |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | 用于构建 Unifia 插件的模板                                  |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Unifia 的 Neovim 前端——基于终端的 AI 编码代理               |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK 提供商，用于通过 @opencode-ai/sdk 使用 Unifia |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Unifia 的 Web / 桌面应用和 VS Code 扩展                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | 将 Unifia 嵌入 Obsidian UI 的 Obsidian 插件                 |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Claude Cowork 的开源替代方案，由 Unifia 驱动                |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia 扩展管理器，支持可移植的隔离配置                     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Unifia 的桌面、Web、移动和远程客户端应用                    |
