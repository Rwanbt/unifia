...
Puede agregar comandos personalizados a través de la configuración Unifia o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su Unifia [config](/docs/config):
...
unifia incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
