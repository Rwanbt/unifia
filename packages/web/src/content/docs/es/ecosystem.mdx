---
title: Ecosistema
description: Proyectos e integraciones construidas con Unifia.
---

Una colección de proyectos comunitarios construidos en Unifia.

:::note
¿Quieres agregar tu proyecto relacionado con Unifia a esta lista? Envíe un PR.
:::

También puedes consultar [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) y [unifia.cafe](https://opencode.cafe), una comunidad que agrega el ecosistema y la comunidad.
...
| Nombre                                                                                             | Descripción                                                                                                                 |
| -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Ejecute automáticamente sesiones Unifia en entornos sandbox aislados de Daytona con git sync y vistas previas en vivo     |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Seguimiento del uso de Unifia con Wakatime                                                                                |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Agentes en segundo plano, herramientas LSP/AST/MCP prediseñadas, agentes seleccionados, compatible con Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Notificaciones de escritorio y alertas sonoras para sesiones Unifia                                                       |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Nomenclatura automática de sesiones Zellij impulsada por IA basada en el contexto Unifia                                  |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Permitir que los agentes Unifia carguen mensajes de forma diferida a pedido con descubrimiento e inyección de habilidades |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Amplíe unifia /commands a un potente sistema de orquestación con control de flujo granular                                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notificaciones nativas del sistema operativo para Unifia: sepa cuándo se completan las tareas                             |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Árboles de trabajo de Git de fricción cero para Unifia                                                                    |
...
| Nombre                                                                                     | Descripción                                                                          |
| ------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------ |
| [kimaki](https://github.com/remorses/kimaki)                                               | Bot de Discord para controlar sesiones Unifia, basado en el SDK                    |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Complemento Neovim para avisos compatibles con el editor, creado en API              |
| [portal](https://github.com/hosenur/portal)                                                | Interfaz de usuario web móvil para Unifia a través de Tailscale/VPN                |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Plantilla para crear complementos Unifia                                           |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Interfaz de Neovim para unifia: un agente de codificación de IA basado en terminal |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Proveedor Vercel AI SDK para usar Unifia a través de @opencode-ai/sdk              |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Aplicación web/de escritorio y extensión VS Code para Unifia                       |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Complemento de Obsidian que incorpora Unifia en la interfaz de usuario de Obsidian |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Una alternativa de código abierto a Claude Cowork, impulsada por Unifia            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Administrador de extensiones Unifia con perfiles portátiles y aislados.            |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Aplicación de escritorio, web, móvil y de cliente remoto para Unifia               |
