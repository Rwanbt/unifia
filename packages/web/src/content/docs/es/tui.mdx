---
title: TUI
description: Usando la interfaz de usuario del terminal Unifia.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unifia proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar Unifia se inicia TUI para el directorio actual.
...
Cuando utilice Unifia TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a Unifia. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de Unifia. _Alias_: `/quit`, `/q`
...
Esto es independiente de `unifia.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
Utilice `UNIFIA_TUI_CONFIG` para cargar una ruta de configuración de TUI personalizada.
