---
title: Zen
description: Lista seleccionada de modelos proporcionada por Unifia.
---
...
Unifia Zen es una lista de modelos probados y verificados proporcionada por el equipo de Unifia.

:::note
Unifia Zen está actualmente en beta.
:::

Zen funciona como cualquier otro proveedor en Unifia. Inicias sesión en Unifia Zen y obtienes
...
:::tip
Probamos un grupo selecto de modelos y proveedores que funcionan bien con Unifia.
:::
...
Unifia Zen es un gateway de AI que te da acceso a estos modelos.

---

## Cómo funciona

Unifia Zen funciona como cualquier otro proveedor en Unifia.

1. Inicias sesión en **<a href={console}>Unifia Zen</a>**, agregas tus datos de facturación
   y copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas Unifia Zen y pegas tu API key.
...
El [identificador del modelo](/docs/config/#models) en tu configuración de Unifia
...
- MiniMax M2.5 Free está disponible en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo V2 Pro Free está disponible en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- MiMo V2 Omni Free está disponible en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Qwen3.6 Plus Free está disponible en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Nemotron 3 Super Free está disponible en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
- Big Pickle es un modelo stealth que es gratuito en Unifia por tiempo limitado. El equipo está usando este tiempo para recopilar comentarios y mejorar el modelo.
...
4. Que no haya **lock-in** al permitirte usarlo con cualquier otro agente de coding. Y permitirte siempre usar también cualquier otro proveedor con Unifia.
