...
Con Unifia puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, Unifia usa nuestro propio tema `unifia`.
...
Unifia viene con varios temas integrados.
...
- Quiere que Unifia coincida con la apariencia de su terminal
...
Unifia admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
