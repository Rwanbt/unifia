...
With Unifia you can select from one of several built-in themes, use a theme that adapts to your terminal theme, or define your own custom theme.

By default, Unifia uses our own `unifia` theme.
...
Unifia comes with several built-in themes.
...
- Want Unifia to match their terminal's appearance
...
Unifia supports a flexible JSON-based theme system that allows users to create and customize themes easily.
