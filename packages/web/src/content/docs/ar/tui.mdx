---
title: TUI
description: استخدام واجهة المستخدم TUI في Unifia.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر Unifia واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل Unifia إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة Unifia في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى Unifia. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من Unifia. _الأسماء المستعارة_: `/quit`, `/q`
...
يمكنك تخصيص سلوك واجهة TUI عبر ملف إعدادات Unifia.
...
استخدم `UNIFIA_TUI_CONFIG` لتحميل مسار إعدادات TUI مخصص.
