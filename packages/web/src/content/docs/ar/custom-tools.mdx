...
description: أنشئ أدوات يمكن لـ LLM استدعاؤها في unifia.
---

الأدوات المخصصة هي دوال تنشئها يمكن لـ LLM استدعاؤها أثناء المحادثات. تعمل جنبا إلى جنب مع [الأدوات المدمجة](/docs/tools) في unifia مثل `read` و`write` و`bash`.
