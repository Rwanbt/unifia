...
:::caution
يتم الآن ضبط الأوضاع عبر خيار `agent` في إعدادات unifia. أصبح خيار
`mode` مُهمَلًا الآن. [اعرف المزيد](/docs/agents).
:::

تتيح لك الأوضاع في unifia تخصيص السلوك والأدوات والمطالبات لحالات استخدام مختلفة.

يأتي مع وضعين مدمجين: **build** و **plan**. يمكنك تخصيصهما أو إعداد
أوضاعك الخاصة عبر إعدادات unifia.
...
قم بإعداد الأوضاع في ملف الإعدادات `unifia.json` لديك:
...
إذا لم يتم تحديد درجة الحرارة، يستخدم unifia القيم الافتراضية الخاصة بكل نموذج (عادةً 0 لمعظم النماذج و 0.55 لنماذج Qwen).
...
إعدادات unifia العالمية وكذلك إعدادات المشروع.
