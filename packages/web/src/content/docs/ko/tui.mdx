---
title: TUI
description: Unifia 터미널 사용자 인터페이스 사용.
---
...
Unifia TUI를 사용할 때 `/` 뒤에 명령 이름을 입력하여 작업을 빠르게 실행할 수 있습니다. 예를 들어:
...
이는 서버/런타임 동작을 구성하는 `unifia.json`과는 별개입니다.
...
`UNIFIA_TUI_CONFIG`를 사용하여 사용자 정의 TUI 설정 경로를 로드할 수 있습니다.
