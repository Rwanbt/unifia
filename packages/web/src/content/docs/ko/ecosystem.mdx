...
:::note
이 목록에 Unifia 관련 프로젝트를 추가하고 싶다면 PR을 제출하세요.
:::

[awesome-unifia](https://github.com/awesome-opencode/awesome-unifia)와 [unifia.cafe](https://opencode.cafe)도 함께 확인해 보세요. ecosystem과 community 정보를 한곳에 모아볼 수 있습니다.
...
| 이름                                                                                               | 설명                                                                                            |
| -------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | git sync와 live preview를 지원하는 격리된 Daytona sandbox에서 Unifia 세션을 자동 실행합니다.  |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Wakatime으로 Unifia 사용량을 추적합니다.                                                      |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | background agent, 사전 구성된 LSP/AST/MCP tool, curated agent, Claude Code 호환성을 제공합니다. |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Unifia 세션에 데스크톱 알림과 사운드 알림을 제공합니다.                                       |
| [opencode-notifier](https://github.com/mohak34/opencode-notifier)                                  | permission, 완료, 오류 이벤트에 대한 데스크톱 알림과 사운드 알림을 제공합니다.                  |
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Unifia 맥락을 기반으로 Zellij session 이름을 AI로 자동 지정합니다.                            |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | skill 탐색과 주입을 통해 Unifia agent가 필요 시 prompt를 lazy load하도록 합니다.              |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | 세밀한 flow control로 unifia /commands를 강력한 orchestration 시스템으로 확장합니다.          |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Unifia 작업 완료 시점을 native OS 알림으로 알려줍니다.                                        |
...
| 이름                                                                                       | 설명                                                                   |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | SDK 기반으로 Unifia 세션을 제어하는 Discord bot입니다.               |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | API 기반 editor-aware prompt를 제공하는 Neovim plugin입니다.           |
| [portal](https://github.com/hosenur/portal)                                                | Tailscale/VPN 환경에서 OpenCode를 쓰기 위한 mobile-first 웹 UI입니다.  |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Unifia plugin 개발을 위한 템플릿입니다.                              |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | terminal 기반 AI 코딩 agent인 opencode용 Neovim frontend입니다.        |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | `@unifia/sdk`로 OpenCode를 사용하는 Vercel AI SDK provider입니다. |
...
| [OpenWork](https://github.com/different-ai/openwork)                                       | Unifia 기반의 Claude Cowork 대체 오픈소스 프로젝트입니다.            |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | 휴대형 격리 프로필을 지원하는 Unifia extension manager입니다.        |
