---
title: Ökosystem
description: Mit Unifia erstellte Projekte und Integrationen.
---

Eine Sammlung von Community-Projekten, die auf Unifia basieren.

:::note
Möchten Sie Ihr OpenCode-bezogenes Projekt zu dieser Liste hinzufügen? Senden Sie einen PR.
:::

Sie können sich auch [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) und [unifia.cafe](https://opencode.cafe) ansehen, eine Community, die das Ökosystem und die Community zusammenfasst.
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Verfolgen Sie die Nutzung von Unifia mit Wakatime                                                                           |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Hintergrundagenten, vorgefertigte LSP/AST/MCP-Tools, kuratierte Agenten, Claude Code-kompatibel                               |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Erweitern Sie Unifia /commands zu einem leistungsstarken Orchestrierungssystem mit granularer Flusskontrolle                |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS-Benachrichtigungen für Unifia – wissen, wann Aufgaben erledigt sind                                               |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Reibungslose Git-Arbeitsbäume für Unifia                                                                                    |
...
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-Plugin für editorfähige Eingabeaufforderungen, basierend auf API      |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-First-Web UI für Unifia über Tailscale/VPN                          |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Vorlage zum Erstellen von OpenCode-Plugins                                   |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-Frontend für Unifia – ein terminalbasierter AI-Coding-Agent         |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK Anbieter für die Verwendung von Unifia über @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/Desktop-App und VS Code-Erweiterung für Unifia                        |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-Plugin, das Unifia in Obsidians UI einbettet                      |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Eine Open-Source-Alternative zu Claude Cowork, unterstützt von Unifia      |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia Erweiterungsmanager mit portablen, isolierten Profilen.             |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop-, Web-, Mobil- und Remote-Client-App für Unifia                    |
