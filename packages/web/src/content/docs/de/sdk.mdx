...
Das unifia JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und unifia programmatisch steuern.
...
`unifia.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn unifia bereits laeuft, kannst du nur einen Client erstellen und verbinden:
