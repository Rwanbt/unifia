...
Mit Unifia kannst du ein eingebautes Theme waehlen, ein an dein Terminal angepasstes Theme nutzen oder ein eigenes Theme definieren.

Standardmaessig verwendet Unifia das `unifia`-Theme.
...
Unifia liefert mehrere eingebaute Themes mit.
...
- Unifia optisch ans Terminal anpassen wollen
...
Unifia unterstuetzt ein flexibles JSON-basiertes Theme-System.
