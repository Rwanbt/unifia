---
title: Zen
description: Kuratierte Modellliste direkt von Unifia.
---
...
Unifia Zen ist eine Liste von getesteten und verifizierten Modellen, die vom OpenCode-Team bereitgestellt wird.

:::note
Unifia Zen befindet sich derzeit in der Beta.
:::

Zen funktioniert wie jeder andere Provider in Unifia. Du meldest dich bei Unifia Zen an und erhältst deinen API-Key. Es ist **vollständig optional** und du musst es nicht verwenden, um Unifia zu nutzen.
...
:::tip
Wir haben eine ausgewählte Gruppe von Modellen und Providern getestet, die gut mit Unifia funktionieren.
:::
...
Unifia Zen ist ein AI-Gateway, das dir Zugriff auf diese Modelle gibt.

---

## So funktioniert es

Unifia Zen funktioniert wie jeder andere Provider in Unifia.

1. Du meldest dich bei **<a href={console}>Unifia Zen</a>** an, hinterlegst deine Zahlungsdaten und kopierst deinen API-Key.
2. Du führst den Befehl `/connect` in der TUI aus, wählst Unifia Zen aus und fügst deinen API-Key ein.
...
- MiniMax M2.5 Free ist für begrenzte Zeit auf Unifia verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Pro Free ist für begrenzte Zeit auf Unifia verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- MiMo V2 Omni Free ist für begrenzte Zeit auf Unifia verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Qwen3.6 Plus Free ist für begrenzte Zeit auf Unifia verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Nemotron 3 Super Free ist für begrenzte Zeit auf Unifia verfügbar. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
- Big Pickle ist ein Stealth-Modell, das für begrenzte Zeit kostenlos auf Unifia verfügbar ist. Das Team nutzt diese Zeit, um Feedback zu sammeln und das Modell zu verbessern.
...
Wir haben Unifia Zen geschaffen, um:
...
4. **keinen Lock-in** zu haben, indem du es mit jedem anderen Coding-Agenten verwenden kannst. Und dir außerdem immer zu erlauben, mit Unifia auch jeden anderen Provider zu verwenden.
