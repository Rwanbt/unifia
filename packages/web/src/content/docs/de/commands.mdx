...
Verwenden Sie die Option `command` in Ihrem Unifia [config](/docs/config):
...
Unifia enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
