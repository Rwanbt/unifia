---
title: TUI
description: Arbeite mit Unifia in der Terminal-Oberflaeche.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unifia bietet eine interaktive Terminaloberflaeche (TUI), um mit einem LLM an deinen Projekten zu arbeiten.

Ohne weitere Argumente startet Unifia die TUI im aktuellen Verzeichnis.
...
Fuegt einen Provider zu Unifia hinzu. Erlaubt die Auswahl aus verfuegbaren Providern und das Hinzufuegen ihrer API-Keys.
...
Beendet Unifia. _Aliase_: `/quit`, `/q`
...
Dies ist getrennt von `unifia.json`, welche das Server-/Runtime-Verhalten konfiguriert.
...
Verwende `UNIFIA_TUI_CONFIG`, um einen benutzerdefinierten TUI-Konfigurationspfad zu laden.
