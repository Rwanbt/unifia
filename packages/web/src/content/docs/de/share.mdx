...
Wenn du eine Unterhaltung teilst, macht Unifia Folgendes:
...
Unifia hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt Unifia den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`unifia.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du unifia in deiner Organisation einsetzt.
