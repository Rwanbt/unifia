...
Mit den Modi in Unifia können Sie das Verhalten, die Tools und die Eingabeaufforderungen für verschiedene Anwendungsfälle anpassen.
...
Unifia verfügt über zwei integrierte Modi.
...
Konfigurieren Sie Modi in Ihrer `unifia.json`-Konfigurationsdatei:
...
Wenn keine Temperatur angegeben ist, verwendet Unifia modellspezifische Standardwerte (normalerweise 0 für die meisten Modelle, 0.55 für Qwen-Modelle).
