---
title: Ecosystem
description: Projects and integrations built with Unifia.
---

A collection of community projects built on Unifia.

:::note
Want to add your Unifia related project to this list? Submit a PR.
:::

You can also check out [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) and [unifia.cafe](https://opencode.cafe), a community that aggregates the ecosystem and community.
...
| Name                                                                                               | Description                                                                                       |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatically run Unifia sessions in isolated Daytona sandboxes with git sync and live previews |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Track Unifia usage with Wakatime                                                                |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Background agents, pre-built LSP/AST/MCP tools, curated agents, Claude Code compatible            |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Desktop notifications and sound alerts for Unifia sessions                                      |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | AI-powered automatic Zellij session naming based on Unifia context                              |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Allow Unifia agents to lazy load prompts on demand with skill discovery and injection           |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Extend unifia /commands into a powerful orchestration system with granular flow control         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Native OS notifications for Unifia – know when tasks complete                                   |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Zero-friction git worktrees for Unifia                                                          |
...
| Name                                                                                       | Description                                                      |
| ------------------------------------------------------------------------------------------ | ---------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot to control Unifia sessions, built on the SDK       |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim plugin for editor-aware prompts, built on the API         |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Unifia over Tailscale/VPN              |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Template for building Unifia plugins                           |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend for unifia - a terminal-based AI coding agent  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK provider for using Unifia via @opencode-ai/sdk   |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App and VS Code Extension for Unifia             |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian plugin that embeds Unifia in Obsidian's UI            |
| [OpenWork](https://github.com/different-ai/openwork)                                       | An open-source alternative to Claude Cowork, powered by Unifia |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia extension manager with portable, isolated profiles.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile and Remote Client App for Unifia          |
