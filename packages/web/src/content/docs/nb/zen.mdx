---
title: Zen
description: Utvalgt liste over modeller levert av Unifia.
---
...
Unifia Zen er en liste over testede og verifiserte modeller levert av OpenCode-teamet.

:::note
Unifia Zen er for øyeblikket i beta.
:::

Zen fungerer som enhver annen leverandør i Unifia. Du logger inn på Unifia Zen og får
...
:::tip
Vi testet en utvalgt gruppe modeller og leverandører som fungerer godt med Unifia.
:::
...
Unifia Zen er en AI gateway som gir deg tilgang til disse modellene.

---

## Slik fungerer det

Unifia Zen fungerer som enhver annen leverandør i Unifia.

1. Du logger inn på **<a href={console}>Unifia Zen</a>**, legger til
   faktureringsdetaljene dine og kopierer API-nøkkelen din.
2. Du kjører kommandoen `/connect` i TUI, velger Unifia Zen og limer inn API-nøkkelen din.
...
- MiniMax M2.5 Free er tilgjengelig på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo V2 Pro Free er tilgjengelig på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- MiMo V2 Omni Free er tilgjengelig på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Qwen3.6 Plus Free er tilgjengelig på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Nemotron 3 Super Free er tilgjengelig på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
- Big Pickle er en stealth-modell som er gratis på Unifia i en begrenset periode. Teamet bruker denne tiden til å samle inn tilbakemeldinger og forbedre modellen.
...
4. Ha **ingen lock-in** ved å la deg bruke det med enhver annen kodeagent. Og alltid la deg bruke enhver annen leverandør med Unifia også.
