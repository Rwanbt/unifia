---
title: Økosystem
description: Prosjekter og integrasjoner bygget med Unifia.
---

En samling fellesskapsprosjekter bygget på Unifia.

:::note
Vil du legge til ditt OpenCode-relaterte prosjekt til denne listen? Send inn en PR.
:::

Du kan også sjekke ut [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) og [unifia.cafe](https://opencode.cafe), et fellesskap som samler økosystemet og fellesskapet.
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Bakgrunnsagenter, forhåndsbygde LSP/AST/MCP verktøy, kurerte agenter, Claude Code-kompatibel                  |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Utvid Unifia /kommandoer til et kraftig orkestreringssystem med granulær flytkontroll                       |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Innfødte OS-varsler for Unifia – vet når oppgaver fullføres                                                 |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Nullfriksjon git-arbeidstre for Unifia                                                                      |
...
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim-plugin for editor-tilpassede meldinger, bygget på API        |
| [portal](https://github.com/hosenur/portal)                                                | Mobile-first web UI for Unifia over Tailscale/VPN                 |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Mal for å bygge OpenCode-plugins                                    |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim-grensesnitt for Unifia - en terminalbasert AI-kodingsagent |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK leverandør for bruk av Unifia via @opencode-ai/sdk  |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web-/skrivebordsapp og VS Code-utvidelse for Unifia               |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian-plugin som bygger inn Unifia i Obsidians UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Et åpen kildekode-alternativ til Claude Cowork, drevet av Unifia  |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia utvidelsesbehandler med bærbare, isolerte profiler.        |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile og Remote Client App for Unifia              |
