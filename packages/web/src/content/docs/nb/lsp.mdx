---
title: LSP-servere
description: unifia integreres med LSP-serverne dine.
---

Unifia integreres med din Language Server Protocol (LSP) for å hjelpe LLM med å samhandle med kodebasen din. Den bruker diagnostikk for å gi tilbakemelding til LLM.

---

## Innebygde servere

Unifia kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `UNIFIA_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når unifia åpner en fil, gjør den:
