...
Moduser i Unifia lar deg tilpasse oppførselen, verktøyene og prompter for ulike brukstilfeller.
...
Unifia kommer med to innebygde moduser.
...
Konfigurer moduser i din `unifia.json` konfigurasjonsfil:
...
Hvis ingen temperatur er spesifisert, bruker Unifia modellspesifikke standardinnstillinger (vanligvis 0 for de fleste modeller, 0,55 for Qwen-modeller).
