...
Agentferdigheter lar Unifia oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
unifia søker etter disse stedene:
...
For prosjektlokale stier går unifia opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
...
unifia viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `unifia.json`:
...
**For innebygde agenter** (i `unifia.json`):
