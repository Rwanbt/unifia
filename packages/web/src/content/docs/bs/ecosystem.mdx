---
title: Ekosistem
description: Projekti i integracije izgrađeni uz Unifia.
---

Kolekcija projekata zajednice izgrađenih na Unifia.

:::note
Želite li na ovu listu dodati svoj Unifia projekat? Pošaljite PR.
:::

Također možete pogledati [awesome-unifia](https://github.com/awesome-opencode/awesome-unifia) i [unifia.cafe](https://opencode.cafe), zajednicu koja spaja ekosistem i zajednicu.
...
| Ime                                                                                                | Opis                                                                                                          |
| -------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------- |
| [opencode-daytona](https://github.com/daytonaio/daytona/tree/main/libs/opencode-plugin)            | Automatski pokrenite Unifia sesije u izoliranim Daytona sandboxovima uz git sinhronizaciju i preglede uživo |
...
| [opencode-wakatime](https://github.com/angristan/opencode-wakatime)                                | Pratite upotrebu Unifia sa Wakatime                                                                         |
...
| [oh-my-unifia](https://github.com/code-yeongyu/oh-my-unifia)                                   | Pozadinski agenti, unapred izgrađeni LSP/AST/MCP alati, kurirani agenti, kompatibilni sa Claude Code          |
| [opencode-notificator](https://github.com/panta82/opencode-notificator)                            | Obavještenja na radnoj površini i zvučna upozorenja za Unifia sesije                                        |
...
| [opencode-zellij-namer](https://github.com/24601/opencode-zellij-namer)                            | Automatsko imenovanje Zellij sesije na bazi Unifia konteksta                                                |
| [opencode-skillful](https://github.com/zenobi-us/opencode-skillful)                                | Dozvolite Unifia agentima da lijeno učitavaju upite na zahtjev uz otkrivanje vještina i ubrizgavanje        |
...
| [@openspoon/subtask2](https://github.com/spoons-and-mirrors/subtask2)                              | Proširite unifia /komande u moćan sistem orkestracije sa granularnom kontrolom toka                         |
...
| [opencode-notify](https://github.com/kdcokenny/opencode-notify)                                    | Notifikacije izvornog OS-a za Unifia – znajte kada se zadaci dovrše                                         |
...
| [opencode-worktree](https://github.com/kdcokenny/opencode-worktree)                                | Git radna stabla bez trenja za Unifia                                                                       |
...
| Ime                                                                                        | Opis                                                                  |
| ------------------------------------------------------------------------------------------ | --------------------------------------------------------------------- |
| [kimaki](https://github.com/remorses/kimaki)                                               | Discord bot za kontrolu Unifia sesija, izgrađen na SDK              |
| [unifia.nvim](https://github.com/NickvanDyke/opencode.nvim)                              | Neovim dodatak za upite svjestan uređivača, izgrađen na API           |
| [portal](https://github.com/hosenur/portal)                                                | Mobilni korisnički interfejs za Unifia preko Tailscale/VPN          |
| [unifia plugin template](https://github.com/zenobi-us/opencode-plugin-template/)         | Predložak za izgradnju Unifia dodataka                              |
| [unifia.nvim](https://github.com/sudo-tee/opencode.nvim)                                 | Neovim frontend za unifia - terminal baziran AI agent za kodiranje  |
| [ai-sdk-provider-opencode-sdk](https://github.com/ben-vargas/ai-sdk-provider-opencode-sdk) | Vercel AI SDK dobavljač za korištenje Unifia putem @opencode-ai/sdk |
| [OpenChamber](https://github.com/btriapitsyn/openchamber)                                  | Web / Desktop App i VS Code Extension za Unifia                     |
| [OpenCode-Obsidian](https://github.com/mtymek/opencode-obsidian)                           | Obsidian dodatak koji ugrađuje Unifia u Obsidian-ov UI              |
| [OpenWork](https://github.com/different-ai/openwork)                                       | Alternativa otvorenog koda Claudeu Coworku, pokretana pomoću Unifia |
| [ocx](https://github.com/kdcokenny/ocx)                                                    | Unifia menadžer ekstenzija sa prenosivim, izolovanim profilima.     |
| [CodeNomad](https://github.com/NeuralNomadsAI/CodeNomad)                                   | Desktop, Web, Mobile i Remote Client aplikacija za Unifia           |
