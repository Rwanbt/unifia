...
ove ili konfigurirajte svoje putem unifia config.
...
unifia dolazi sa dva ugrađena načina rada.
...
Konfigurirajte načine rada u svom `unifia.json` konfiguracijskom fajlu:
...
Ako temperatura nije navedena, unifia koristi podrazumijevane postavke specifične za model (obično 0 za većinu modela i 0.55 za Qwen modele).
