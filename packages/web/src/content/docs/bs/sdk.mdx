---
title: SDK
description: Type-safe JS klijent za unifia server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

unifia JS/TS SDK pruza type-safe klijent za interakciju sa serverom.
...
Mozete proslijediti konfiguracijski objekat za prilagodavanje ponasanja. Instanca i dalje ucitava `unifia.json`, ali konfiguraciju mozete nadjacati ili dodati inline:
...
Ako vec imate pokrenutu unifia instancu, mozete napraviti klijentsku instancu i povezati se na nju:
