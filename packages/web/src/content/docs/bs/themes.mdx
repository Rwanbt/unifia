...
U Unifia mozete birati izmedu vise ugradenih tema, koristiti temu koja se prilagodava terminalu ili definisati vlastitu temu.

Po defaultu, Unifia koristi nasu `unifia` temu.
...
Unifia dolazi sa vise ugradenih tema.
...
- Zele da Unifia odgovara izgledu njihovog terminala
...
Unifia podrzava fleksibilan sistem tema baziran na JSON-u koji olaksava kreiranje i prilagodavanje tema.
