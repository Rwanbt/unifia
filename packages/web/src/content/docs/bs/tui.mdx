---
title: TUI
description: Korištenje korisničkog interfejsa Unifia terminala.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

Unifia pruža interaktivni terminalski interfejs ili TUI za rad na vašim projektima sa LLM.

Pokretanje Unifia pokreće TUI za trenutni direktorij.
...
Kada koristite Unifia TUI, možete upisati `/` nakon čega slijedi ime komande da biste brzo izvršili radnje. na primjer:
...
Dodajte provajdera u Unifia. Omogućava vam da odaberete između dostupnih provajdera i dodate njihove API ključeve.
...
Izađite iz Unifia. _Aliases_: `/quit`, `/q`
...
Ovo je odvojeno od `unifia.json`, koji konfiguriše ponašanje servera/izvršavanja.
...
Koristite `UNIFIA_TUI_CONFIG` da učitate prilagođenu putanju TUI konfiguracije.
