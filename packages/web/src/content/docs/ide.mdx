---
title: IDE
description: The Unifia extension for VS Code, Cursor, and other IDEs
---

Unifia integrates with VS Code, Cursor, or any IDE that supports a terminal. Just run `unifia` in the terminal to get started.
...
To install Unifia on VS Code and popular forks like Cursor, Windsurf, VSCodium:

1. Open VS Code
2. Open the integrated terminal
3. Run `unifia` - the extension installs automatically
...
Search for **Unifia** in the Extension Marketplace and click **Install**.
...
- Ensure you’re running `unifia` in the integrated terminal.
