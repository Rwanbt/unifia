---
title: TUI
description: Korzystanie z interfejsu użytkownika terminala unifia.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

unifia zapewnia interaktywny interfejs terminala lub TUI do pracy nad projektami za pomocą LLM.

Uruchomienie unifia uruchamia TUI dla bieżącego katalogu.
...
Korzystając z TUI unifia, możesz wpisać `/`, po którym następuje nazwa polecenia, aby szybko wykonać działania. Na przykład:
...
Dodaj dostawcę do unifia. Umożliwia wybór dostępnych dostawców i dodanie ich kluczy API.
...
Zamknij unifia. _Aliasy_: `/quit`, `/q`
...
Jest to oddzielny plik od `unifia.json`, który konfiguruje zachowanie serwera/runtime.
...
Użyj `UNIFIA_TUI_CONFIG`, aby załadować niestandardową ścieżkę konfiguracji TUI.
