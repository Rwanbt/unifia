---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez Unifia.
---
...
Unifia Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół Unifia.

:::note
Unifia Zen jest obecnie w wersji beta.
:::

Zen działa jak każdy inny dostawca w Unifia. Logujesz się do Unifia Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z Unifia.
:::
...
Unifia Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

Unifia Zen działa jak każdy inny dostawca w Unifia.

1. Logujesz się do **<a href={console}>Unifia Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz Unifia Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji Unifia używa formatu
...
- MiniMax M2.5 Free jest dostępny w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Pro Free jest dostępny w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- MiMo V2 Omni Free jest dostępny w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Qwen3.6 Plus Free jest dostępny w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Super Free jest dostępny w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w Unifia przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w Unifia także dowolnego innego dostawcy.
