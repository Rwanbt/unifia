...
Dzięki unifia możesz wybrać jeden z kilku wbudowanych motywów, użyć motywu, który dostosowuje się do motywu terminala lub zdefiniować własny, niestandardowy motyw.

Domyślnie unifia używa naszego własnego motywu `unifia`.
...
unifia ma kilka wbudowanych motywów.
...
- Chcą, aby Unifia pasował do wyglądu ich terminala
...
unifia obsługuje elastyczny system motywów oparty na JSON, który pozwala użytkownikom łatwo tworzyć i dostosowywać motywy.
