...
import { Ed25519ManifestVerifier, signCapabilityManifest } from "../src/index.ts"
...
const registry = new CapabilityRegistry(new Ed25519ManifestVerifier(publicKey.export({ type: "spki", format: "pem" })))
