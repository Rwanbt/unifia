export const dict = {
  ...
  "ui.message.you": "Dig",
  "ui.message.pinChapter": "Fastgør som kapitel",
  ...
  "ui.sessionTurn.diffs.changed.one": "{{count}} ændret fil",
  "ui.sessionTurn.diffs.changed.other": "{{count}} ændrede filer",
  "ui.sessionTurn.diffs.showAll": "Vis alle",
  "ui.sessionTurn.diffs.showLess": "Vis færre",
  "ui.sessionTurn.diffs.more": "+{{count}} filer mere",
  "ui.tool.status.completed": "Færdig",
