export const dict = {
  ...
  "ui.message.readAloud": "Ler em voz alta",
  "ui.message.you": "Você",
  "ui.message.pinChapter": "Fixar como capítulo",
  "ui.message.comingSoon": "Em breve",
  "ui.sessionTurn.diffs.changed.one": "{{count}} arquivo alterado",
  "ui.sessionTurn.diffs.changed.other": "{{count}} arquivos alterados",
  ...
  "ui.tool.status.completed": "Concluído",
  "ui.tool.status.running": "Em andamento",
