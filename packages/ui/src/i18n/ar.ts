export const dict = {
  ...
  "ui.message.you": "أنت",
  "ui.message.pinChapter": "تثبيت كفصل",
  ...
  "ui.message.comingSoon": "قريبًا",
  "ui.sessionTurn.diffs.changed.one": "{{count}} ملف معدّل",
  "ui.sessionTurn.diffs.changed.other": "{{count}} ملفات معدّلة",
  "ui.sessionTurn.diffs.showAll": "عرض الكل",
  "ui.sessionTurn.diffs.showLess": "عرض أقل",
  "ui.sessionTurn.diffs.more": "+{{count}} ملفات أخرى",
  "ui.tool.status.completed": "تم",
