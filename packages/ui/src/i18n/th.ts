export const dict = {
  ...
  "ui.sessionReview.title.branch": "การเปลี่ยนแปลงของ branch",
  ...
  "ui.message.you": "คุณ",
  "ui.message.pinChapter": "ปักหมุดเป็นบท",
  "ui.message.unpinChapter": "Remove chapter",
  "ui.message.chapter": "Chapter",
  "ui.message.comingSoon": "เร็ว ๆ นี้",
  "ui.sessionTurn.diffs.changed.one": "แก้ไข {{count}} ไฟล์",
  "ui.sessionTurn.diffs.changed.other": "แก้ไข {{count}} ไฟล์",
  "ui.sessionTurn.diffs.showAll": "แสดงทั้งหมด",
  "ui.sessionTurn.diffs.showLess": "แสดงน้อยลง",
  "ui.sessionTurn.diffs.more": "+อีก {{count}} ไฟล์",
  "ui.tool.status.completed": "เสร็จสิ้น",
