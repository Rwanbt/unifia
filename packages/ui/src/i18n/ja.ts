export const dict = {
  ...
  "ui.message.you": "あなた",
  "ui.message.pinChapter": "チャプターとして固定",
  "ui.message.comingSoon": "近日公開",
  "ui.sessionTurn.diffs.changed.one": "{{count}} 件のファイルを変更",
  "ui.sessionTurn.diffs.changed.other": "{{count}} 件のファイルを変更",
  "ui.sessionTurn.diffs.showAll": "すべて表示",
  "ui.sessionTurn.diffs.showLess": "表示を減らす",
  "ui.sessionTurn.diffs.more": "ほか {{count}} ファイル",
  "ui.tool.status.completed": "完了",
