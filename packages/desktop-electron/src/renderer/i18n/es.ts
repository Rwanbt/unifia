export const dict = {
  ...
  "desktop.updater.none.message": "Ya estás usando la versión más reciente de Unifia",
  ...
  "desktop.updater.downloaded.prompt":
    "Se ha descargado la versión {{version}} de Unifia. ¿Quieres instalarla y reiniciar?",
