 ...
 * packages/opencode/src/collective/provider-discovery.ts (TEAM-B02
 ...
 *   - C01 (packages/opencode/src/model-intelligence/) owns the registry of
 ...
 *     packages/opencode/src/collective/provider-discovery.ts, which converts
 *     MultiModelDiscoveredProvider into the legacy DiscoveredProvider shape.
 *
 * Hard constraints (B02 scope manifest):
 *   - No imports from packages/opencode/src/team/** (G01/G02 figé).
 *   - No imports from packages/opencode/src/model-intelligence/** (C01 figé).
