 ...
 *
 * Distinct from C01 (packages/opencode/src/model-intelligence/registry.ts) :
 ...
 *
 * No imports from packages/opencode/src/model-intelligence/** (we don't
 * redefine registry behaviour — we just provide ergonomic helpers).
 * No imports from packages/opencode/src/team/** or collective/**.
 */
