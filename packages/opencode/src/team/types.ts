 ...
 * existing module in packages/opencode/src/team/ imports this file yet
 ...
 *    interop. Nothing in packages/opencode/src/team/** depends on `effect`
 ...
 *
 *  - Errors: NamedError.create from "@opencode-ai/util/error", the same
