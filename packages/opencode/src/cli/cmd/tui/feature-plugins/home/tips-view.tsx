...
const TIPS = [
  ...
  "Create {highlight}unifia.json{/highlight} for server settings and {highlight}tui.json{/highlight} for TUI settings",
  ...
  "Unifia auto-handles OAuth for remote MCP servers requiring auth",
  ...
  "Unifia auto-formats files using prettier, gofmt, ruff, and more",
  'Set {highlight}"formatter": false{/highlight} in config to disable all auto-formatting',
  "Define custom formatter commands with file extensions in config",
  "Unifia uses LSP servers for intelligent code analysis",
  ...
  "Create a plugin to prevent Unifia from reading sensitive files",
  "Use {highlight}unifia run{/highlight} for non-interactive scripting",
  "Use {highlight}unifia --continue{/highlight} to resume the last session",
  "Use {highlight}unifia run -f file.ts{/highlight} to attach files via CLI",
  "Use {highlight}--format json{/highlight} for machine-readable output in scripts",
  "Run {highlight}unifia serve{/highlight} for headless API access to Unifia",
  "Use {highlight}unifia run --attach{/highlight} to connect to a running server",
  "Run {highlight}unifia upgrade{/highlight} to update to the latest version",
  "Run {highlight}unifia auth list{/highlight} to see all configured providers",
  "Run {highlight}unifia agent create{/highlight} for guided agent creation",
  "Use {highlight}/opencode{/highlight} in GitHub issues/PRs to trigger AI actions",
  "Run {highlight}unifia github install{/highlight} to set up the GitHub workflow",
  ...
  "Run {highlight}unifia debug config{/highlight} to troubleshoot configuration",
  ...
  "Run {highlight}docker run -it --rm ghcr.io/rwanbt/opencode{/highlight} for containerized use",
  "Use {highlight}/connect{/highlight} with Unifia Zen for curated, tested models",
