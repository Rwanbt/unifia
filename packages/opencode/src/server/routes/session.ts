  ...
  new Hono()
    .get(
      ...
      describeRoute({
        ...
        description: "Get a list of all Unifia sessions, sorted by most recently updated.",
    ...
    .get(
      ...
      describeRoute({
        summary: "Get session",
        description: "Retrieve detailed information about a specific Unifia session.",
        tags: ["Session"],
    ...
    .post(
      ...
      describeRoute({
        ...
        description: "Create a new Unifia session for interacting with AI assistants and managing conversations.",
