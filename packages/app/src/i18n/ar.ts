export const dict = {
  ...
  "settings.desktop.remote.mode.description": "اختر الأجهزة التي يمكنها الوصول إلى خادم OpenCode.",
  ...
  "settings.desktop.remote.mode.internetTooltip": "عرّض OpenCode عبر HTTPS/WSS. أعد توجيه المنفذ في جهاز التوجيه للوصول الخارجي.",
  ...
  "settings.desktop.remote.warning.internet": "يعرّض وضع الإنترنت OpenCode للإنترنت العام. استخدم كلمة مرور قوية، وفكّر في جدار حماية أو VPN للاستخدام الإنتاجي.",
  ...
  "settings.desktop.remote.connection.description": "افتح هذا الـ URL في متصفح الهاتف (نفس شبكة Wi-Fi). سجّل الدخول باسم المستخدم 'opencode' وكلمة المرور أعلاه.",
  "settings.desktop.remote.connection.noLan": "لم يُكتشف عنوان LAN.",
  "settings.desktop.remote.pair.title": "إقران الهاتف الذكي",
  "settings.desktop.remote.pair.descriptionLan": "امسح بكاميرا الهاتف لفتح OpenCode Mobile مُعبّأ مسبقًا لهذا الخادم (نفس شبكة Wi-Fi).",
  "settings.desktop.remote.pair.descriptionLocal": "امسح بكاميرا الهاتف لفتح OpenCode Mobile عبر USB — شغّل `adb reverse tcp:PORT tcp:PORT` أولاً.",
  "settings.desktop.remote.pair.unavailable": "رمز QR غير متاح",
  "settings.desktop.remote.restartRequired": "أعد تشغيل OpenCode لتطبيق التغييرات.",
  "settings.desktop.remote.warning": "الوصول عن بُعد يعرّض OpenCode على شبكتك المحلية. استخدم كلمة مرور قوية ووثق بشبكة Wi-Fi.",
  "settings.desktop.remote.warning.firewall": "الإعداد لأول مرة: اسمح لـ OpenCode (أو Node.js) عبر جدار حماية Windows عند المطالبة، وإلا فستُسقط الاتصالات الواردة من هاتفك بصمت.",
  ...
  "settings.fork.config.exportDescription": "تنزيل opencode-config.json مع جميع إعداداتك",
  ...
  "settings.fork.config.importDescription": "استعادة من ملف opencode-config.json مُصدَّر",
  ...
  "settings.fork.android.allFilesPath": "الإعدادات → التطبيقات → OpenCode → الأذونات → الوصول إلى جميع الملفات",
  ...
  "settings.desktop.remote.toast.certificateRotatedDescription": "أعد تشغيل OpenCode لتطبيق الشهادة الجديدة.",
