export const dict = {
  ...
  "settings.desktop.remote.mode.description": "Odaberi koji uređaji mogu pristupiti OpenCode serveru.",
  ...
  "settings.desktop.remote.mode.internetTooltip": "Izloži OpenCode putem HTTPS/WSS. Proslijedi port na ruteru za vanjski pristup.",
  ...
  "settings.desktop.remote.warning.internet": "Internet način izlaže OpenCode javnom internetu. Koristi jaku lozinku. Razmisli o firewall-u ili VPN-u za produkcijsku upotrebu.",
  ...
  "settings.desktop.remote.connection.description": "Otvori ovaj URL u pregledniku pametnog telefona (ista Wi-Fi mreža). Prijavi se sa korisnikom 'opencode' i lozinkom iznad.",
  ...
  "settings.desktop.remote.pair.descriptionLan": "Skeniraj kamerom telefona da otvoriš OpenCode Mobile unaprijed popunjen za ovaj server (ista Wi-Fi mreža).",
  "settings.desktop.remote.pair.descriptionLocal": "Skeniraj kamerom telefona da otvoriš OpenCode Mobile preko USB-a — prvo pokreni `adb reverse tcp:PORT tcp:PORT`.",
  "settings.desktop.remote.pair.unavailable": "QR kod nedostupan",
  "settings.desktop.remote.restartRequired": "Restartuj OpenCode kako bi promjene stupile na snagu.",
  "settings.desktop.remote.warning": "Udaljeni pristup izlaže OpenCode na tvojoj lokalnoj mreži. Koristi jaku lozinku i vjeruj svojoj Wi-Fi mreži.",
  "settings.desktop.remote.warning.firewall": "Prvo postavljanje: dozvoli OpenCode (ili Node.js) kroz Windows Firewall kada se to zatraži, inače će dolazne veze sa tvog telefona tiho biti odbačene.",
  ...
  "settings.fork.config.exportDescription": "Preuzmi opencode-config.json sa svim tvojim postavkama",
  ...
  "settings.fork.config.importDescription": "Vrati iz izvezene opencode-config.json datoteke",
  ...
  "settings.fork.android.allFilesPath": "Postavke → Aplikacije → OpenCode → Dozvole → Pristup svim datotekama",
  ...
  "settings.desktop.remote.toast.certificateRotatedDescription": "Restartuj OpenCode da primijeniš novi certifikat.",
