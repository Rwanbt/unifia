export const dict = {
  ...
  "settings.desktop.remote.mode.description": "เลือกเครื่องที่สามารถเข้าถึงเซิร์ฟเวอร์ OpenCode ได้",
  ...
  "settings.desktop.remote.mode.internetTooltip": "เปิดให้เข้าถึง OpenCode ผ่าน HTTPS/WSS ต้องส่งต่อพอร์ตบนเราเตอร์เพื่อให้เข้าถึงจากภายนอกได้",
  ...
  "settings.desktop.remote.warning.internet": "โหมดอินเทอร์เน็ตเปิดให้ OpenCode เข้าถึงได้จากอินเทอร์เน็ตสาธารณะ ใช้รหัสผ่านที่รัดกุม และควรใช้ไฟร์วอลล์หรือ VPN สำหรับการใช้งานจริง",
  ...
  "settings.desktop.remote.connection.description": "เปิด URL นี้ในเบราว์เซอร์ของสมาร์ทโฟน (Wi-Fi เดียวกัน) เข้าสู่ระบบด้วยผู้ใช้ 'opencode' และรหัสผ่านด้านบน",
  "settings.desktop.remote.connection.noLan": "ไม่พบที่อยู่ LAN",
  "settings.desktop.remote.pair.title": "จับคู่สมาร์ทโฟน",
  "settings.desktop.remote.pair.descriptionLan": "สแกนด้วยกล้องโทรศัพท์เพื่อเปิด OpenCode Mobile ที่กรอกข้อมูลเซิร์ฟเวอร์นี้ไว้ล่วงหน้า (Wi-Fi เดียวกัน)",
  "settings.desktop.remote.pair.descriptionLocal": "สแกนด้วยกล้องโทรศัพท์เพื่อเปิด OpenCode Mobile ผ่าน USB — รันคำสั่ง `adb reverse tcp:PORT tcp:PORT` ก่อน",
  "settings.desktop.remote.pair.unavailable": "ไม่มี QR ให้ใช้งาน",
  "settings.desktop.remote.restartRequired": "รีสตาร์ท OpenCode เพื่อให้การเปลี่ยนแปลงมีผล",
  "settings.desktop.remote.warning": "การเข้าถึงระยะไกลเปิดให้ OpenCode เข้าถึงได้บนเครือข่ายท้องถิ่นของคุณ ใช้รหัสผ่านที่รัดกุมและเชื่อถือ Wi-Fi ที่ใช้งาน",
  "settings.desktop.remote.warning.firewall": "การตั้งค่าครั้งแรก: อนุญาต OpenCode (หรือ Node.js) ผ่าน Windows Firewall เมื่อมีการแจ้งเตือน มิฉะนั้นการเชื่อมต่อขาเข้าจากโทรศัพท์ของคุณจะถูกปฏิเสธโดยไม่มีการแจ้งเตือน",
  ...
  "settings.fork.android.allFilesPath": "เส้นทาง: Settings → Apps → OpenCode → Permissions → All Files Access",
  ...
  "settings.desktop.remote.toast.certificateRotatedDescription": "รีสตาร์ท OpenCode เพื่อใช้ใบรับรองใหม่",
