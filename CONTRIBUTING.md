...
By default, `bun dev` runs Unifia in the `packages/opencode` directory. To run it against a different directory or repository:
...
- Core pieces:
  - `packages/opencode`: Unifia core business logic & server.
