...
| `packages/opencode/test/provider/models-refresh.test.ts` | 2 |
| `packages/opencode/test/sync/index.test.ts` | 2 |
...
| `packages/opencode/src/cli/cmd/generate.ts` | 1 |
| `packages/opencode/src/cli/cmd/tui/context/helper.tsx` | 1 |
| `packages/opencode/src/cli/cmd/tui/context/theme.tsx` | 1 |
| `packages/opencode/src/control-plane/adaptors/index.ts` | 1 |
| `packages/opencode/src/file/watcher.ts` | 1 |
| `packages/opencode/src/server/instance.ts` | 1 |
| `packages/opencode/src/server/routes/tui.ts` | 1 |
| `packages/opencode/src/session/llm.ts` | 1 |
| `packages/opencode/src/session/message-v2.ts` | 1 |
| `packages/opencode/test/server/provider-refresh-routes.test.ts` | 1 |
