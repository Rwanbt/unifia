...
# Prompt de review indépendante — PLAN R6 (issue #116)

Copier ce prompt avec les trois fichiers suivants :

1. `PLAN-PIXEL-PERFECT-PORT-2026-09-17-R6.md` ;
2. les synthèses R3, R4 et R5 ;
...
Tu reviews en lecture seule le PLAN R6 de port visuel v110 d'Unifia. Le plan existe parce
...
branch    new-ui
plan      docs/ui-reference/v110/PLAN-PIXEL-PERFECT-PORT-2026-09-17-R6.md
...
7. Ne recopie pas les findings R3/R4/R5 sans vérifier que R6 ne les a pas déjà fermés.
...
Vérifie : PF0, commits antérieurs des locks pilote/qualification, train tool-only/lock-only,
image reproductible, issue #116, StaticCase/MotionCase, census symétrique par état,
state-policy, cardinalités, clés, ledger, profils et scan `data-parity`.
...
Vérifie : locks/configs/outils, image/Bun, contextes, référence non instrumentée, mutations
harness/interaction séparées, quiescence/timeline, A/A multi-processus, résidu, masques,
fontes/licences, census SVG/pseudo/focusable, responsive, DPR2, locales et motion.
...
Vérifie en simulation froide PF0, P0a, P0b, P1, S0, QF0, S3, S7, S8 et S15. Contrôle les chemins,
...
- vérifier que les trois ancres passent le profile pilote final au plus tard en troisième PR ;
...
1. PF0/P0a/P0b rendent-ils P1 atteignable sans auto-signature ni plus de deux PR d'infra ?
...
Le plan R6 est actuellement **PROPOSÉ**. La review ne doit ni commencer l'implémentation ni
