...
# Prompt de review indépendante — PLAN R5 (issue #116)

Copier ce prompt avec les trois fichiers suivants :

1. `PLAN-PIXEL-PERFECT-PORT-2026-09-17-R5.md` ;
2. les synthèses R3 et R4 ;
...
Tu reviews en lecture seule le PLAN R5 de port visuel v110 d'Unifia. Le plan existe parce
...
branch    new-ui
plan      docs/ui-reference/v110/PLAN-PIXEL-PERFECT-PORT-2026-09-17-R5.md
...
7. Ne recopie pas les findings R3/R4 sans vérifier que R5 ne les a pas déjà fermés.
...
Vérifie : identité Git, contract/environment locks, plan commité, issue #116, compteurs,
manifest, census, state-policy, cardinalités, clés sémantiques, ledger, exemptions, cas et
scan `data-parity`.
...
- retirer une ancre du manifest ou un état dû ;
...
Vérifie : locks/configs/outils, isolation prouvée des BrowserContext, référence non mutée,
timer registry, A/A spatial, résidu, masques sémantiques, fontes hors réseau, états,
pseudo-éléments, responsive, DPR2, locales et motion séparée.
...
- vérifier que les deux ancres pilotes passent le contrat final dans la deuxième PR ;
...
1. P0 peut-il produire le mini-runner, puis P1 rendre les deux ancres vertes en deux PR ?
...
Le plan R5 est actuellement **PROPOSÉ**. La review ne doit ni commencer l'implémentation ni
