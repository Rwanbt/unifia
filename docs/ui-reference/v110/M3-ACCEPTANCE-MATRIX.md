...
| Design selection handles (8 points) | desktop-large | drag handle | maquette | transformer Konva (8 ancres + rotation) vérifié par e2e (#105) ; polylignes : ancres (#110) et poignées de courbe (#111) ; multi-sélection/marquee requis par la maquette (`startMarquee`, HTML L22592) → #112 | ⚠️ partiel |
