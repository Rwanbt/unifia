//! Kokoro phoneme tokenizer — maps IPA characters to token IDs.
//! Vocabulary from Kokoro v1.0 model.

use std::collections::HashMap;
use std::sync::OnceLock;

static VOCAB: OnceLock<HashMap<char, u8>> = OnceLock::new();

fn vocab() -> &'static HashMap<char, u8> {
    VOCAB.get_or_init(|| {
        let pairs: &[(char, u8)] = &[
            (';', 1), (':', 2), (',', 3), ('.', 4), ('!', 5), ('?', 6),
            ('—', 9), ('…', 10), ('"', 11), ('(', 12), (')', 13),
            ...
            ('ɥ', 99), ('ɨ', 101), ('ɪ', 102), ('ʝ', 103), ('ɯ', 110),
            ('ɰ', 111), ('ŋ', 112), ('ɳ', 113), ('ɲ', 114), ('ɴ', 115),
            ('ø', 116), ('ɸ', 118), ('θ', 119), ('œ', 120), ('ɹ', 123),
            ('ɾ', 125), ('ɻ', 126), ('ʁ', 128), ('ɽ', 129), ('ʂ', 130),
            ('ʃ', 131), ('ʈ', 132), ('ʧ', 133), ('ʊ', 135), ('ʋ', 136),
            ('ʌ', 138), ('ɣ', 139), ('ɤ', 140), ('χ', 142), ('ʎ', 143),
            ('ʒ', 147), ('ʔ', 148), ('ˈ', 156), ('ˌ', 157), ('ː', 158),
            ('ʰ', 162), ('ʲ', 164), ('↓', 169), ('→', 171), ('↗', 172),
            ('↘', 173), ('ᵻ', 177),
        ];
...
/// Convert IPA phoneme string to token IDs (with start/end padding)
pub fn phonemes_to_tokens(phonemes: &str) -> Vec<i64> {
    let v = vocab();
    let mut tokens = Vec::with_capacity(phonemes.len() + 2);
    tokens.push(0); // start token
    for c in phonemes.chars() {
        if let Some(&id) = v.get(&c) {
